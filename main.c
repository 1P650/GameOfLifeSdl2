...
=== ЕСТЬ === 1) Раздельный рендеринг поля и интерфейса === ЕСТЬ ===
2) Кнопка "Шаг" ---СДЕЛАТЬ---
3) Кнопка "Очистка" сделать иконку === ЕСТЬ ===
4) Придумать правила:
Можно задавать правила как конечный автомат,
где каждое из состояний есть количество соседей
Более того, можно просто задать массив этих состояний, причём каждый из вариантов может быть не равен предыдущему
Этого будет вполне достаточно
==ПОКА СДЕЛАНО, ПОДУМАЮ НАД СПОСОБАМИ ЗАДАНИЯ КОНЕЧНЫХ АВТОМАТОВ==
5) Сделать закрашивание по зажатию
Наверное надо будет отслеживать предыдущее действие в отношении клетки ==СДЕЛАНО==
